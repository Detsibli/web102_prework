...
const displayStr = `A total of $${totalRaisedAll.toLocaleString()} has been raised for ${totalGamesCount} games. Currently, ${numUnfunded} ${numUnfunded === 1 ? "game remains" : "games remain"} unfunded. We need your help to fund these amazing games!`;
